...
\begin{figure}[H]
    ...
    \caption{PI-Based Control System Block Diagram}
\end{figure}
...
\bibitem[Sunaina et al., 2021]{sunaina2021} Sunaina, T., et al. (2021). Design of Primary Sewage Treatment Plant for Cherpulassery Municipality. \textit{International Research Journal of Engineering and Technology (IRJET)}.
\bibitem[Arduino, 2026]{arduino2026} Arduino. (2026). \textit{Arduino Uno Rev3 Official Documentation \& Reference}.
\bibitem[OpenJS Foundation, 2026]{nodejs2026} OpenJS Foundation. (2026). \textit{Node.js Documentation}.
\bibitem[Meta Platforms, 2026]{react2026} Meta Platforms, Inc. (2026). \textit{React: The library for web and native user interfaces}.
\bibitem[OpenAI, 2026]{chatgpt2026} OpenAI. (2026). \textit{ChatGPT} (GPT-4 architecture) [Large language model].
\bibitem[Anthropic, 2026]{claude2026} Anthropic. (2026). \textit{Claude} (Claude 3.5 architecture) [Large language model].
\end{thebibliography}
