...
export default function Sidebar({ collapsed, onToggle }) {
  return (
    <aside
      className={`
        relative flex flex-col h-screen bg-[#0d1117] border-r border-white/[0.07]
                ...
                {collapsed && (
                  <span
                    className="
                      ...
                      bg-[#1a2235] text-text-primary border border-white/[0.07]
      ...
      <div className="p-3 border-t border-white/[0.07]">
        <button
          ...
          className={`
            ...
            hover:text-text-primary hover:bg-white/[0.05] transition-all duration-150
            ${collapsed ? 'justify-center px-0' : ''}
          `}
        >
          {collapsed ? (
