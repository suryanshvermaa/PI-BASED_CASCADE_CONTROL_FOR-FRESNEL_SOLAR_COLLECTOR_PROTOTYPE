  ...
  return (
    <div className="p-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Placeholder for additional devices */}
        <div className="glass-card p-5 border-dashed border-white/[0.1] flex flex-col items-center justify-center min-h-[180px] text-center hover:border-primary/30 hover:bg-primary/[0.03] transition-all duration-200 cursor-pointer group">
          <div className="h-10 w-10 rounded-xl bg-white/[0.04] group-hover:bg-primary/10 flex items-center justify-center ring-1 ring-white/[0.07] group-hover:ring-primary/25 transition-all duration-200 mb-3">
